...
import com.wangsheng.fastdevlibrary.httputil.Convert;
import com.wangsheng.fastdevlibrary.httputil.LzyResponse;
import com.wangsheng.fastdevlibrary.httputil.SimpleResponse;
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
     ...
     *     .tag(this)//
     *     .execute(new JsonDialogCallback<LzyResponse<ServerModel>>(this) {
     *          @Override
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (rawType == Void.class) {
            //无数据类型,表示没有data数据的情况（以  new JsonDialogCallback<LzyResponse<Void>>(this)  以这种形式传递的泛型)
