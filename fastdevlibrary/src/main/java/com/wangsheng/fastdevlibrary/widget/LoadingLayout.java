...
/**
 * 加载中、空页面、错误页面、内容页  默认显示的为第四个 loadingView
 * 重试按钮的id必须为指定的id
 */
public class LoadingLayout extends FrameLayout {

    private int emptyView, errorView, loadingView,retryView;
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            retryView = a.getResourceId(R.styleable.LoadingLayout_retryView, R.layout.retry_view);
