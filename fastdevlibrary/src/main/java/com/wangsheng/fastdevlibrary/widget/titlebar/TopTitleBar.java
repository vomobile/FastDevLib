...
import com.wangsheng.fastdevlibrary.commonutils.StatusBarUtil;
...
public class TopTitleBar extends LinearLayout implements View.OnClickListener {
     ...
     * titlebar返回按钮图片
     */
    private int mBackIconRes = R.drawable.btn_back_normal;
    ...
    public TopTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackIconRes = typedArray.getResourceId(R.styleable.TopTitleBar_tb_back_icon, R.drawable.btn_back_normal);
