...
public class CharacterPickerView extends FrameLayout {
    ...
    public void setPickerList(List<KeyValue> options1Items,List<KeyValue> options2Items,List<KeyValue> options3Items){
        wheelOptions.setPickerKV(options1Items,options2Items,options3Items);
    }
    ...
    public void setOnWheelItemChangeListener(OnWheelItemChangeListener listener) {
        this.wheelOptions.setOnItemListener(listener);
    }

    public void setPickerOne(List<KeyValue> keyValues){
        this.wheelOptions.setPickerOne(keyValues);
    }

    public void setPickerTwo(List<KeyValue> keyValues){
        this.wheelOptions.setPickerTwo(keyValues);
    }

    public void setPickerThree(List<KeyValue> keyValues){
        this.wheelOptions.setPickerThree(keyValues);
    }
}
