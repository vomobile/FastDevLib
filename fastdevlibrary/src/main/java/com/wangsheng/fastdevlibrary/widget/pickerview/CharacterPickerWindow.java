...
public class CharacterPickerWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void setPickerKV(List<KeyValue> options1Items,
                          List<KeyValue> options2Items,
                          List<KeyValue> options3Items) {
        pickerView.setPickerList(options1Items, options2Items, options3Items);
    }
