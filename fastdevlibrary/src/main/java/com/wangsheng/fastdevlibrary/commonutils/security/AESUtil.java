package com.wangsheng.fastdevlibrary.commonutils.security;
...
public class AESUtil {
	...
	public static String Encrypt(String sSrc) throws Exception {
		...
		return new String(Base64.encode(encrypted),"UTF-8");//此处使用BAES64做转码功能，同时能起到2次加密的作用。
	}
	...
	public static String Decrypt(String sSrc) throws Exception {
		try {
			...
			byte[] encrypted1 = Base64.decode(sSrc.getBytes("UTF-8"));//先用bAES64解密
			try {
